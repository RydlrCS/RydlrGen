...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create users
        users = [
            User(username='thundergod', email='thundergod@mhigh.edu', password=make_password('thundergodpassword')),
            User(username='metalgeek', email='metalgeek@mhigh.edu', password=make_password('metalgeekpassword')),
            User(username='zerocool', email='zerocool@mhigh.edu', password=make_password('zerocoolpassword')),
            User(username='crashoverride', email='crashoverride@hmhigh.edu', password=make_password('crashoverridepassword')),
            User(username='sleeptoken', email='sleeptoken@mhigh.edu', password=make_password('sleeptokenpassword')),
        ]
        ...
        team.save()
        team.members.set(users)  # Assuming a Many-to-Many relationship
